...
func NewNodeVolumePublicist(
	...
	return (&nodeVolumePublicist{
		p:               p,
		privateMountDir: privateMountDir,
		validateDevice:  true,
	}).handle
}
...
func (i *nodeVolumePublicist) publish(
	...
	if req.VolumeId == "" {
		return gocsi.ErrVolumeIDRequired
	}
	...
	case *csi.VolumeCapability_Block:
		if accessType.Block == nil {
			return gocsi.ErrBlockTypeRequired
		}
		if readOnly {
			return status.Error(
	...
	case *csi.VolumeCapability_Mount:
		if accessType.Mount == nil {
			return gocsi.ErrMountTypeRequired
		}
...
func (i *nodeVolumePublicist) unpublish(
	...
	if mountPoints == 1 {
		...
		return os.RemoveAll(privMntTgtPath)
	}
